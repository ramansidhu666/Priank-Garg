    ...
    public partial class NewsLetter : System.Web.UI.Page
    {
        ...
        protected void FillGridData()
       {
        ...
        public string SendNewsLetter(NewsLetterModel model)
        {
            ...
            {
                model.Logopath = "http://priankgarg.com/images/logo.png";
            }
           

            if (model.PropertyPhoto  == null || model.PropertyPhoto == "")
            {
                model.PropertyPhoto = "http://priankgarg.com/images/img1.png";
            }
        ...
        public void Firstnewsletter(NewsLetterModel Model)
        {
            ...
            //else
            //{
            //    Model.Logopath = "..http://priankgarg.com/images/MyLogodd%20-%20Copy.png";
            //}
            Model.AdminPhoto = "http://priankgarg.com/images/ajay_shah.jpg";
