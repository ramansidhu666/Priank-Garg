            ...
            <div style="float: left; width: 100%; background: white; border-radius: 6px; padding:10px;">
                ...
                <div style="float: left; width: 100%; margin-bottom: 12px;">
                    ...
                    <div style="float: left; width: 62%; margin-top: 20px;">
                        <h2 style="margin-bottom: 5px; font-family:arial; font-size: 18px;">Priank Garg</h2>
                        <p style="margin-bottom: 5px; font-family:arial;">Broker Of Record</p>
                        <p style="font-weight: bold; margin-bottom: 5px; font-family:arial;">E-Mail:<span style="font-weight: normal; margin: 0 0px 0 6px;">info@priankgarg.com</span></p>
                        <p style="font-weight: bold; margin-bottom: 5px; font-family:arial;">Phone:<span style="font-weight: normal; margin: 0 0px 0 6px;">647-607-0063</span></p>
                    </div>
